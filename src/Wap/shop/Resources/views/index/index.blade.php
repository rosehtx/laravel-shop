...
<link rel="stylesheet" type="text/css" href="{{asset('vendor/wap/shop/assets/css/pre_foot.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('vendor/wap/shop/assets/css/pro-detail.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('vendor/wap/shop/assets/css/font-awesome.min.css')}}">
<link rel="stylesheet" type="text/css" href="{{asset('vendor/wap/shop/assets/css/showbox.css')}}">
<link rel="stylesheet" href="../../static/css/layer.css" id="layuicss-skinlayercss">
<script src="{{asset('vendor/wap/shop/assets/js/showbox.js')}}"></script>
<script src="{{asset('vendor/wap/shop/assets/js/jquery.js')}}"></script>
<script type="text/javascript" src="{{asset('vendor/wap/shop/assets/js/layer.js')}}"></script>
<script src="{{asset('vendor/wap/shop/assets/js/load_task.js')}}" type="text/javascript"></script>
...
<div class="slick">
    <div style="display:block;text-align:center;width:100%;height:175px;line-height:175px;">
    	<a href="#">
    		<img src="../../static/picture/1497070640.png" alt="" style="height:175px;max-width:100%/* ;height:auto; */display: inline-block !important;vertical-align: middle !important;">
    	</a>
	</div>
</div>
	...
	<section class="members_goodspic">
		<ul>
					...
					<div class="imgs">
						...
						<img class="lazy" src="../../static/picture/1500547407503.jpg" style="max-width:100%;">
						</a>
					</div>
					<div class="info">
					...
					<div class="imgs">
						...
						<img class="lazy" src="../../static/picture/1500600767633.jpg" style="max-width:100%;">
						</a>
					</div>
					<div class="info">
					...
					<div class="imgs">
						...
						<img class="lazy" src="../../static/picture/1500600673623.jpg" style="max-width:100%;">
						</a>
					</div>
					<div class="info">
					...
					<div class="imgs">
						...
						<img class="lazy" src="../../static/picture/1500601152703.jpg" style="max-width:100%;">
						</a>
					</div>
					<div class="info">
...
<!--  -->
<!-- 促销模块 -->
<!-- 	<div class="controltype" style="background-image:url(../../static/images/newproduct.png);background-repeat:no-repeat;height:50px;margin:0;width:100%">
		<hr />
		<span class="control_l_content">清凉一夏</span>
	</div>
	<div class="slick">
		<div><a href="http://tp.23673.com/wap"><img src="../../static/picture/guanggao_cs_02.jpg" alt=""></a></div>
	</div>
	<section class="members_goodspic">
		<ul>
						<li class="gooditem">
				<div class="img">
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=380"><img class="lazy" src="../../static/picture/1500547407503.jpg"></a>
				</div>
				<div class="info">
					<p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=380">印花显瘦A字碎花真丝连衣裙女夏季2017新款欧洲站气质裙子女装潮</a></p>
					<p class="goods-price"><em>￥359.00</em></p>
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=380"><div class="goods-buy"></div></a>
						...
						<li class="gooditem">
				<div class="img">
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=382"><img class="lazy" src="../../static/picture/1500600767633.jpg"></a>
				</div>
				<div class="info">
					<p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=382">M Queen独立制衣 优雅V领褶皱飘带系带修身长裙A字吊带连衣裙8915</a></p>
					<p class="goods-price"><em>￥599.00</em></p>
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=382"><div class="goods-buy"></div></a>
						...
						<li class="gooditem">
				<div class="img">
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=381"><img class="lazy" src="../../static/picture/1500600673623.jpg"></a>
				</div>
				<div class="info">
					<p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=381">2016夏装新款夜店豹纹性感露背低胸女装超短裙抹胸紧身包臀连衣裙</a></p>
					<p class="goods-price"><em>￥500.00</em></p>
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=381"><div class="goods-buy"></div></a>
						...
						<li class="gooditem">
				<div class="img">
					<a href="http://tp.23673.com/wap/goods/goodsdetail?id=383"><img class="lazy" src="../../static/picture/1500601152703.jpg"></a>
				</div>
				<div class="info">
					<p class="goods-title"><a href="http://tp.23673.com/wap/goods/goodsdetail?id=383">单鞋细高跟防水台鱼嘴女凉鞋2017春夏季新款复古刺绣高跟鞋40-42</a></p>
					<p class="goods-price"><em>￥345.00</em></p>
